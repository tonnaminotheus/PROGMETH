...
public class DrawUtil {
	...
	// private static String congrat_path =
	// ClassLoader.getSystemResource("images/congratulations.png").toString();
	 ...
	 * //System.out.println(image_path); gc.drawImage(congratsprites, x-200, y-80);
	 * }
	 */
}
